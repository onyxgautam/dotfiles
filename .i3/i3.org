...
bindsym $mod+b exec rofi -show window -dpi 1
#+end_src
...
mode "$mode_monitors" {
  ...
  bindsym 2 exec "xrandr --output eDP1 --mode 3200x1800 --output DP1 --same-as DP1 --mode 3840x2160 --scale 0.833x0.833"
...
#+begin_src conf
set $term alacritty
bindsym $mod+Return $exec emacsclient -e "(call-interactively 'eshell-other-frame)"
